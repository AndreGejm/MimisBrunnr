...
- document new env vars in `docs/reference/env-vars.md` in the same change that introduces them
...
- If role names or auth sources change, update this file and `docs/reference/env-vars.md` together
