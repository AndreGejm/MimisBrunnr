...
- Create `packages/domain/src/contexts/context-authority-state.ts` for the six authority states from `docs/planning/read-path-alignment-rfc.md`.
...
- Modify: `docs/planning/go-live-gates.md`
- Modify: `docs/planning/current-implementation.md`
...
```bash
git add tests/e2e/retrieval-strategy-diff.test.mjs tests/e2e/service-boundaries-and-regression.test.mjs docs/planning/go-live-gates.md docs/planning/current-implementation.md docs/planning/backlog.md
...
- `docs/planning/read-path-alignment-rfc.md` requires explicit invariants, authority-state schema, namespace semantics, retrieval metrics, rollout criteria, import discipline, and session archive gating.
...
Plan complete and saved to `docs/superpowers/plans/2026-04-06-read-path-alignment-implementation-plan.md`. Two execution options:
