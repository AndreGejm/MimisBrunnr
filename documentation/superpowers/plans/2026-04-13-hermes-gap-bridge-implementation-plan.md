...
- [ ] Create `documentation/local-agent-context.md`.
...
- [ ] Create `documentation/qwen3-coder-local-profile.md`.
...
- [ ] Run `rg -n "assemble-agent-context|search-session-archives|qwen3-coder|non-authoritative|memoryContext" documentation packages`.
