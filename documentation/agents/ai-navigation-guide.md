...
1. `README.md`
2. `documentation/reference/repo-map.md`
3. `documentation/architecture/overview.md`
4. `documentation/architecture/invariants-and-boundaries.md`
5. `documentation/reference/interfaces.md`
6. `documentation/reference/env-vars.md`
