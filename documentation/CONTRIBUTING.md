...
3. `documentation/setup/configuration.md`
4. `documentation/architecture/overview.md`
5. `documentation/architecture/invariants-and-boundaries.md`
6. `documentation/reference/interfaces.md`
7. `documentation/agents/ai-navigation-guide.md`

Treat `documentation/planning/` as historical context unless a file explicitly describes a still-current contract and matches the code.
...
- user/operator-facing behavior: `README.md`, `documentation/operations/*`, `documentation/reference/interfaces.md`
- setup or env vars: `documentation/setup/*`, `documentation/reference/env-vars.md`
- architectural boundaries: `documentation/architecture/*`
- repository navigation or edit safety: `documentation/reference/repo-map.md`, `documentation/agents/ai-navigation-guide.md`
