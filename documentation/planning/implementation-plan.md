...
Reserved MCP tool contracts and the future adapter surface are documented in `documentation/planning/mcp-tool-map.md`.
...
This file is a rollout plan, not a current-state runtime guide. For the current implementation, use `README.md`, `documentation/architecture/overview.md`, and `documentation/reference/interfaces.md`.
